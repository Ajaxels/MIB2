function [flow,labels] = maxflow_v222(A,T)
...
% 11.08.2015, a modified version of maxflow that uses GPL based maxflow version 2.22 
% by Ilya Belevich

[flow,labels] = maxflowmex_v222(A,T);

% release the dll
clear maxflowmex_v222
