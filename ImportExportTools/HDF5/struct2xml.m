...
% s.XMLname.AttributesText.attrib1 = "Some value";
% s.XMLname.Element.Text = "Some text";
% s.XMLname.DifferentElement{1}.AttributesText.attrib2 = "2";
% s.XMLname.DifferentElement{1}.Text = "Some more text";
% s.XMLname.DifferentElement{2}.AttributesText.attrib3 = "2";
% s.XMLname.DifferentElement{2}.AttributesText.attrib4 = "1";
...
% 31.03.2016 Ilya Belevich, replaced Attributes with AttributesText to be compatible with
% Fiji Big Data Viewer XML header format
    ...
    for i = 1:length(fnames)
        ...
        if (strcmp(curfield,'AttributesText'))
            ...
            if (isstruct(s.(curfield)))
                attr_names = fieldnames(s.AttributesText);
                for a = 1:length(attr_names)
                    ...
                    [cur_str,succes] = val2str(s.AttributesText.(cur_attr));
                    if (succes)
