%showMRCSlice  Display a MRC Image in the correct orientation
%
...
%
%  showMRCSlice performs a rot90 then a flipud on the image data to orient it
...
function showMRCSlice(im, xvalue, yvalue)
