...
%
% The plugins should be placed under
% |mib->Plugins| directory as |PLUGIN_GROUP_NAME/PLUGIN_NAME|, where PLUGIN_GROUP_NAME is a directory with similarly grouped
% plugins. PLUGIN_NAME - is a directory with the actual plugin. The name of controller for each plugin should be formed as: 
...
%
% * *Triple area intensity* - a plugin to calculate intensity in 3 related
% areas in images and calculate the ratios. Click the Help button in the
% plugin for details
%
%% Organelle analysis
%
...
%% Plasmodesmata
%
% Plugins for analysis of plasmadesmata in roots of Arabidopsis thaliana. For details please follow to this publication:
