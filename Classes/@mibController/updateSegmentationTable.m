...
if obj.mibModel.I{obj.mibModel.Id}.modelType < 256 
    ...
    tableData{3, 1} = colergen(sprintf('''rgb(%d, %d, %d)''', ...
            round(obj.mibModel.I{obj.mibModel.Id}.modelMaterialColors(mod(str2double(obj.mibModel.I{obj.mibModel.Id}.modelMaterialNames{1}), 65535), 1)*255), ...
            round(obj.mibModel.I{obj.mibModel.Id}.modelMaterialColors(mod(str2double(obj.mibModel.I{obj.mibModel.Id}.modelMaterialNames{1}), 65535), 2)*255), ...
            round(obj.mibModel.I{obj.mibModel.Id}.modelMaterialColors(mod(str2double(obj.mibModel.I{obj.mibModel.Id}.modelMaterialNames{1}), 65535), 3)*255)),'&nbsp;');  % rgb(0,255,0)
    tableData{3, 2} = obj.mibModel.I{obj.mibModel.Id}.modelMaterialNames{1};  
    tableData{3, 3} = false; 
    
    tableData{4, 1} = colergen(sprintf('''rgb(%d, %d, %d)''', ...
            round(obj.mibModel.I{obj.mibModel.Id}.modelMaterialColors(mod(str2double(obj.mibModel.I{obj.mibModel.Id}.modelMaterialNames{2}), 65535), 1)*255), ...
            round(obj.mibModel.I{obj.mibModel.Id}.modelMaterialColors(mod(str2double(obj.mibModel.I{obj.mibModel.Id}.modelMaterialNames{2}), 65535), 2)*255), ...
            round(obj.mibModel.I{obj.mibModel.Id}.modelMaterialColors(mod(str2double(obj.mibModel.I{obj.mibModel.Id}.modelMaterialNames{2}), 65535), 3)*255)),'&nbsp;');  % rgb(0,255,0)
