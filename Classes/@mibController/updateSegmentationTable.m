...
if obj.mibModel.I{obj.mibModel.Id}.modelType < 256 
    ...
    tableData{3, 1} = colergen(sprintf('''rgb(%d, %d, %d)''', ...
            round(obj.mibModel.I{obj.mibModel.Id}.modelMaterialColors(str2double(obj.mibModel.I{obj.mibModel.Id}.modelMaterialNames{1}), 1)*255), ...
            round(obj.mibModel.I{obj.mibModel.Id}.modelMaterialColors(str2double(obj.mibModel.I{obj.mibModel.Id}.modelMaterialNames{1}), 2)*255), ...
            round(obj.mibModel.I{obj.mibModel.Id}.modelMaterialColors(str2double(obj.mibModel.I{obj.mibModel.Id}.modelMaterialNames{1}), 3)*255)),'&nbsp;');  % rgb(0,255,0)
    tableData{3, 2} = obj.mibModel.I{obj.mibModel.Id}.modelMaterialNames{1};  
    tableData{3, 3} = false; 
    
    tableData{4, 1} = colergen(sprintf('''rgb(%d, %d, %d)''', ...
            round(obj.mibModel.I{obj.mibModel.Id}.modelMaterialColors(str2double(obj.mibModel.I{obj.mibModel.Id}.modelMaterialNames{2}), 1)*255), ...
            round(obj.mibModel.I{obj.mibModel.Id}.modelMaterialColors(str2double(obj.mibModel.I{obj.mibModel.Id}.modelMaterialNames{2}), 2)*255), ...
            round(obj.mibModel.I{obj.mibModel.Id}.modelMaterialColors(str2double(obj.mibModel.I{obj.mibModel.Id}.modelMaterialNames{2}), 3)*255)),'&nbsp;');  % rgb(0,255,0)
