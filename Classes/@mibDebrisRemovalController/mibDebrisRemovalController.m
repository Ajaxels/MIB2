...
classdef mibDebrisRemovalController < handle
    ...
    methods
        function obj = mibDebrisRemovalController(mibModel, varargin)
            ...
            global Font;
            if ~isempty(Font)
              if obj.View.handles.Intensitythreshold.FontSize ~= Font.FontSize + 4 ...  % guide font size is 4 points smaller than in appdesigner
                    || ~strcmp(obj.View.handles.Intensitythreshold.FontName, Font.FontName)
